...
- 🧭**Contexte** 
  ...
  Il stage au sein du ***centre international de recherche agronomique (CIRAD)***
...
- **🗺️ Données raster uniquement **: Le package est centré sur les raster, avec peu de support natif pour d’autres types de données environnementales comme les shapefiles vectoriels.
...
# [<span style="color:#FFFFFF">🖥️ Cas Pratique : Interface Graphique</span>](http://127.0.0.1:5699)
